...
(
    ID              INT AUTO_INCREMENT  NOT NULL,
    TYPE            VARCHAR(10)         NOT NULL    COMMENT '입고 OR 출고', # TODO : ENUM ('INSERT', 'RELEASE')으로 변경
...
(
    ...
    STATUS                  BOOLEAN            NULL           COMMENT '판매 중(Y) OR 판매 중지(N)', # TODO : ENUM ('ON_SALE', 'STOP_SALE')으로 변경
    ...
    WAREHOUSE_SECTION_ID    INT                NOT NULL       COMMENT '창고 구역 ID(FK)',
    ...
    CONSTRAINT FK_PRODUCTS_WAREHOUSE_SECTION_ID FOREIGN KEY (WAREHOUSE_SECTION_ID)  REFERENCES WAREHOUSE_SECTION (ID)
) ENGINE = INNODB DEFAULT CHARSET = UTF8MB4 COLLATE = UTF8MB4_0900_AI_CI
    COMMENT = '상품';
...
(
    ID             INT AUTO_INCREMENT NOT NULL,
    QUANTITY       INT                NULL                                 COMMENT '주문 수량',
